...
export default function Player() {
    ...
    return (
        <div className="fixed bottom-4 left-1/2 -translate-x-1/2 w-[95%] max-w-470.5 z-50">
            <LiquidGlass
                className="liquid-fix liquid-justify-between w-full flex flex-row flex-nowrap items-center gap-4 px-6 py-3 rounded-[30px] overflow-hidden
                    bg-linear-to-b from-[#000000] via-[#000000]/31 via-52% to-[#FFFFFF]/31
            ...
            >
                ...
                <div className="flex items-center gap-1.75 max-w-205.75 flex-1 min-w-40 md:min-w-75">
                    ...
                    <div className="relative flex-1 min-w-40 md:min-w-75 h-5 flex items-center">
                        ...
                        />
                        <div
                            className="absolute left-0 top-1/2 -translate-y-1/2 h-1.5 rounded-full bg-[#FF6302]"
