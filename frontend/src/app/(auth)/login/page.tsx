    ...
    const handle_submit = useCallback(
        async (e: React.MouseEvent) => {
            ...
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
                ...
                set_error(err.message || 'Помилка входу');
            } finally {
                set_loading(false);
            }
        },
        ...
        <main className={`${styles.page}`}>
            ...
            <LiquidGlass className={styles.card}>
                ...
                <p className={styles.subtitle}>
                    Log In in your account and continue&nbsp; managing your
                    <br />
                ...
                <div className={styles.inp_wrap}>
                    ...
                    <input
                        ...
                        type="email"
                        placeholder="Enter your email adross"
                        value={email}
                ...
                <div className={styles.socials}>
                    <Link className={styles.soc_btn} href="/auth/facebook" type="button">
                    ...
                    <Link className={styles.soc_btn} href="/auth/google" type="button">
                        <img src="/logo/google.svg" alt="Google logo" className={styles.google_logo} />
                        Google
                    </Link>
                    <Link className={styles.soc_btn} href="/auth/instagram" type="button">
